...
export default function WaterHDTStaffMats(props) {
    return (
        <Box width={1 / 2}>
            ...
            <Flex>
                <Box width={1 / 3}></Box>
                <img src={WaterHDTStaff} height="75" width="75" />
            </Flex>
            <Flex>
            ...
            <Flex>
                <Card width={[75, 150]}>
                    ...
                    <Text fontSize={[1, 2]}>{props.wbFWaStSphereCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={WaterHDTTail} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbFWaStTailCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={WaterHDTHorn} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbFWaStHornCount}</Text>
                </Card>
            </Flex>
            <Flex>
                <Card width={[75, 150]}>
                    <img src={WaterHDTHeart} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbFWaStHeartCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={Orichalcum} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbFWaStOriCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={Rupies} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbFWaStRupeeCost} in millions</Text>
                </Card>
            </Flex>
        </Box>
    )
