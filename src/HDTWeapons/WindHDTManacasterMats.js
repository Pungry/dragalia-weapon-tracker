...
export default function WindHDTManacasterMats(props) {
    return (
        <Box width={1 / 2}>
            ...
            <Flex>
                <Box width={1 / 3}></Box>
                <img src={WindHDTManacaster} height="75" width="75" />
            </Flex>
            <Flex>
            ...
            <Flex>
                <Card width={[75, 150]}>
                    ...
                    <Text fontSize={[1, 2]}>{props.wbWiHMSphereCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={WindHDTTail} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbWiHMTailCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={WindHDTHorn} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbWiHMHornCount}</Text>
                </Card>
            </Flex>
            <Flex>
                <Card width={[75, 150]}>
                    <img src={WindHDTHeart} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbWiHMHeartCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={Orichalcum} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbWiHMOriCount}</Text>
                </Card>
                <Card width={[75, 150]}>
                    <img src={Rupies} height="50" width="50" />
                    <Text fontSize={[1, 2]}>{props.wbWiHMRupeeCost} in millions</Text>
                </Card>
            </Flex>
        </Box>
    )
