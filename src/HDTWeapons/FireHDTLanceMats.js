        ...
        <Box width={[11 / 20, 2 / 5]} mx="auto">
            ...
            <Box sx={{ border: "3px solid blue" }} bg={"#152238"}>
                <Flex>
                    ...
                    <Image src={FireHDTLance} sx={{ width: ["50%", "20%"] }, {height: ["50%", "20%"]}} />
                </Flex>
                <Flex>
                ...
                <Flex alignItems="center">
                    <Card width={[75, 150]}>
                        ...
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLSphereCount}</Text>
                    </Card>
                    <Card width={[75, 150]}>
                        <Image src={FireHDTTail} sx={{ width: ["100%", "70%"], height: ["75%", "35%"] }} />
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLTailCount}</Text>
                    </Card>
                    <Card width={[75, 150]}>
                        <Image src={FireHDTHorn} sx={{ width: ["100%", "70%"], height: ["75%", "35%"] }} />
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLHornCount}</Text>
                    </Card>
                </Flex>
                <Flex>
                    <Card width={[75, 150]}>
                        <Image src={FireHDTHeart} sx={{ width: ["100%", "70%"], height: ["60%", "65%"] }} />
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLHeartCount}</Text>
                    </Card>
                    <Card width={[75, 150]}>
                        <Image src={Orichalcum} sx={{ width: ["90%", "75%"], height: ["60%", "70%"] }} />
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLOriCount}</Text>
                    </Card>
                    <Card width={[75, 150]}>
                        <Image src={Rupies} sx={{ width: ["90%", "70%"], height: ["60%", "70%"] }} />
                        <Text color={"crimson"} fontSize={[1, 2]}>{props.wbFHLRupeeCost} in millions</Text>
                    </Card>
                </Flex>
            </Box>
        </Box>
